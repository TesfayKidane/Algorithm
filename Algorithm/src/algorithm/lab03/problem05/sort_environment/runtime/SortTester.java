package algorithm.lab03.problem05.sort_environment.runtime;

import java.io.BufferedReader;
import java.io.FileReader;
import java.util.Arrays;
import java.util.Stack;
import algorithm.lab03.problem05.sort_environment.util.RandomPermutations;
import java.util.*;


public class SortTester {
	private final String PACKAGE = "algorithm.lab03.problem05.sort_environment.sortroutines";
	private final String FILENAME = "src/algorithm/lab03/problem05/sort_environment/sorters_to_be_run.txt";
